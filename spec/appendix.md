...
log it vouches for. One entry, VTI-APV-014, is recorded here although it was
never listed above: the divergence was known to its implementer and closed
before anyone added it, and the history is recorded so that the omission is not
taken for conformance all along.
